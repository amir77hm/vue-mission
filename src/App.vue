<template>
  <div class="min-h-screen bg-white dark:bg-gray-900">
    <!-- Navigation Bar -->
    <nav
      class="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-800 shadow-md"
    >
    ...
    <!-- Main Content -->
    <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8 my-16">
      <router-view />
    </main>
    ...
    <footer class="bg-gray-800 text-white py-4 fixed bottom-0 left-0 right-0">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <p class="text-center text-sm">
          &copy; {{ new Date().getFullYear() }} Amir Mac. All rights reserved.
        </p>
      </div>
    </footer>
  </div>
